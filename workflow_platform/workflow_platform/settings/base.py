"""
Base settings for Workflow Platform
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='workflow_platform'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A powerful workflow automation platform',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@workflowplatform.com')
